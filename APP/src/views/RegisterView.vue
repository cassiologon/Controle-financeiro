<template>
  <div class="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-purple-500 via-pink-600 to-primary-500">
    <!-- Animated Background -->
    ...
    <div class="relative z-10 w-full max-w-md px-4 sm:px-6 lg:px-8">
      <div class="animate-scale-in">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-4xl font-bold text-white mb-2">Crie sua conta</h1>
          ...
          <form class="space-y-5" @submit.prevent="handleRegister">
            <div class="space-y-4">
              ...
              <Input
                ...
                :success="form.password_confirmation && form.password === form.password_confirmation ? 'Senhas coincidem' : undefined"
              />
            </div>
            ...
            <Button
              ...
              variant="primary"
              :loading="loading"
              class="w-full text-lg py-4 mt-6"
            >
              Criar conta
            </Button>
          </form>
