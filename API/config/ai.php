...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configuração do agente que analisa os gastos do usuário e gera sugestões
    | de economia. O modelo padrão é de raciocínio, então o esforço aplicado é
    | ajustável e o timeout é mais alto do que o de uma geração comum.
    |
    */

    'insights' => [
        'provider' => env('AI_INSIGHTS_PROVIDER', 'openai'),
        'model' => env('AI_INSIGHTS_MODEL', 'gpt-5.6-luna'),
        'reasoning_effort' => env('AI_INSIGHTS_REASONING_EFFORT', 'medium'),
        'timeout' => env('AI_INSIGHTS_TIMEOUT', 120),
    ],
    ...
    */
    ...
    'categorization' => [
        'provider' => env('AI_CATEGORIZATION_PROVIDER', 'openai'),
        'model' => env('AI_CATEGORIZATION_MODEL', 'gpt-5.6-luna'),
